            ...
            <section className="testimonial">
                <div className="center">
                    <div className="testimonial__top">
                        <h2 className="testimonial__title title title--pink">
                            Clientes satisfeitos
                        </h2>
                        <p className="testimonial__description description description--blue">
                            O que eles dizem sobre meus projetos
                        </p>
                    </div>
                        ...
                        <Slider {...settings}>
                            <div className="testimonial__card">
                                <div className="testimonial__icon">
                                    <svg className="testimonial__icon--svg" version="1.1" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Quotemarks-left">
                                            <path className="testimonial__icon--path"
                                                d="M50.6292648,26.225668c-0.1288986-1.3934994-0.0303001-5.1816006,3.5985985-10.4492006 
                                            ...
                                            />
                                            <path className="testimonial__icon--path"
                                                d="M15.1136675,26.225668c-0.1299-1.3896008-0.0341997-5.1748009,3.5985994-10.4492006
                                ...
                                <p className="testimonial__text description description--blue">
                                    I've been working with these guys for a long time
                                    and I can say that my house is the perfect hands.
                                </p>
                                <div className="testimonial__bottom">
                                    <div className="testimonial__photo--one"></div>
                                    <p className="testimonial__name">Jonas Borges</p>
                                </div>
                            </div>
                            <div className="testimonial__card">
                                <div className="testimonial__icon">
                                ...
                                <div className="testimonial__bottom">
                                    <div className="testimonial__photo--two"></div>
                                    <p className="testimonial__name">Jonas Borges</p>
                                </div>
                            </div>
                            <div className="testimonial__card">
                                ...
                                <div className="testimonial__bottom">
                                    <div className="testimonial__photo--three"></div>
                                    <p className="testimonial__name">Jonas Borges</p>
                                </div>
                            </div>
                        </Slider>
